                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        ...
                        <div>
                            ...
                            <div class="mt-6 p-4 bg-surface-100 dark:bg-surface-800 rounded-lg border border-surface-200 dark:border-surface-700">
                                <p class="text-sm text-surface-600 dark:text-surface-400 mb-2">
                                    <strong>Test Credentials:</strong>
                                </p>
                                <p class="text-xs text-surface-500 dark:text-surface-500">
                                    Username: <code class="bg-surface-200 dark:bg-surface-700 px-2 py-1 rounded">admin</code><br>
                                    Password: <code class="bg-surface-200 dark:bg-surface-700 px-2 py-1 rounded">admin</code>
                                </p>
                            </div>
                        </div>
                    </div>
